 ...
 *  
 */
public class TestUDTF2 extends GenericUDTF {
  ...
  public void process(Object[] args) throws HiveException {
    ...
    try {
      prop.load(TestUDTF2.class.getClassLoader().getResourceAsStream("connection.properties"));
    } catch (IOException e) {
      e.printStackTrace();
    }
    ...
    Statement stmt;
    ResultSet rs;
    String sql = "select '" + TestUDTF2.class.getName() + "' from system.dual";
    String result = "";
    try {
