 ...
 *  
 */
public class TestUDTF3 extends GenericUDTF {
  ...
  public void close() throws HiveException {
    ...
    try {
      prop.load(TestUDTF3.class.getClassLoader().getResourceAsStream("connection.properties"));
    } catch (IOException e) {
      e.printStackTrace();
    }
    ...
    Statement stmt;
    ResultSet rs;
    String sql = "select '" + TestUDTF3.class.getName() + "' from system.dual";
    String result = "";
    try {
